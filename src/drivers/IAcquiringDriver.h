...
public:
    ...
    /// зміна будь-якого стороннього параметра дасть хибне «ціль змінилась», фасад піде
    /// гілкою Open→Probe→Close і лишить обладнання роз'єднаним при заповненому
    /// ИДУстройства — рівно та регресія, яку закрито в a9436c3. Компілятор цього не
