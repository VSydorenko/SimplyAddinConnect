...
/**
 * @brief Вычисление CRC-32 для бинарных данных
 * 
 * @param data Вектор байтов для расчета контрольной суммы
 * @return uint32_t Вычисленное значение CRC32
 * 
 * @details Алгоритм реализует стандартный полином CRC-32 (0x04C11DB7) для проверки 
 * целостности данных. Используется для контроля целостности данных при передаче или хранении.
 */
