...
| 07 | Правила написання тестів | [testing-rules.md](testing-rules.md) | Три правила проти хибно-зеленого: негативна верифікація, **доказ стану перед перевіркою**, поріг двома вимірами; два сорти пастки й межі правил |
