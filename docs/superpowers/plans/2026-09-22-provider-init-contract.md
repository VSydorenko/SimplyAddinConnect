...
натомість у issue (Task 9) додається абзац про виявлене. Далі — Task 5.
...
- Modify: `AGENTS.md` — **лише після** мерджу в апстрім (Task 9), не зараз
...
- [ ] **Крок 5: Коміт нічого не потребує** — гілки вже запушені.

---

## Task 10: Закриття — повний гейт, анонс, живий прогін
...
- [ ] **Крок 3: Анонс зміни контракту сусідній сесії**
...
завершеною з **явною відміткою** «п.4 не перевірено», а не мовчки.

- [ ] **Крок 5: Створити PR у `main`**
...
стан апстрім-PR, і **явно** — що з п.4 (живий прогін) і що з рішенням по C2.
...
12–15); §12 документація → Task 8; §10 доставка → Task 9; §13 критерії приймання → Task 10.
Критерій 9 спеки (живий прогін) — Task 10 крок 4. Критерій 8 (анонс) — Task 10 крок 3.
...
блок, створений Task 6 кроком 3 — виконувати в порядку. Task 9 потребує SHA коммітів із
Tasks 3, 4, 5. Task 8 крок «`AGENTS.md`» свідомо відкладено до мерджу апстріму.
